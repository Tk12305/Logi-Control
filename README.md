...
It provides a polished control panel for Logitech devices that Solaar recognises, including receiver/device discovery, diagnostics, supported hardware settings, Logi Bolt pairing through Solaar, and Bluetooth visibility through BlueZ.
...
1. Plug in a Logi Bolt receiver or connect a supported Bluetooth device.
2. Start **Logi Control**.
3. Click **Refresh devices**.
4. Select your mouse or keyboard from the **Active device** dropdown.
5. Use the hardware controls that your device exposes.
